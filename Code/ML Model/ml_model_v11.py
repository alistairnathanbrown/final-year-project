...
# MODEL WITH KMEANS 7, UPDATED TO RDS5, WITH FEATURE INTERACTIONS, FEATURES PRUNED, HYPER PARAMETER TUNING V2
...
data[numerical_cols + ["Wind Speed × Capacity", "Debt-to-GDP × Credit Rating"]] = num_imputer.fit_transform(data[numerical_cols + ["Wind Speed × Capacity", "Debt-to-GDP × Credit Rating"]])
...
numerical_cols += ["Wind Speed × Capacity", "Debt-to-GDP × Credit Rating"]
...
grid_search = GridSearchCV(RandomForestClassifier(random_state=42, class_weight="balanced"), param_grid, cv=3, scoring='roc_auc', n_jobs=-1, verbose=2)
